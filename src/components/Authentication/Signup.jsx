                ...
                <div className="w-full bg-white rounded-lg shadow sm:max-w-md  font-poppins">
                    <div className="p-6 space-y-4 md:space-y-5 sm:p-8">
                        ...
                        <form onSubmit={handleSubmit(create)} className="space-y-4 " >
                            ...
                            <div>
                                {!loading ? (<button type="submit" className="w-full text-white bg-primary-600 bg-blue-600   active:bg-blue-800  font-medium rounded-lg  px-5 py-3 lg:py-2.5 lg:text-sm text-center ">Create an account</button>)
                                    :
                                    (<button type="submit" class="w-full text-white bg-blue-600 active:bg-blue-800 lg:hover:bg-blue-700  font-medium rounded-md px-5  py-3 lg:py-2.5 lg:text-sm text-center flex items-center justify-center">
