        ...
        <div className="max-w-[91%] mx-auto">
            <form onSubmit={handleSubmit(formHandler)} className="flex flex-wrap md:flex-row flex-col font-poppins py-10">
                ...
                <div className="md:w-1/3 w-full px-2 mt-4 md:mt-0 flex flex-col gap-2">
                    ...
                    <div>
                        {!loading ?
                            (<Button type="submit" bgColor={"bg-blue-600"} className="w-full py-3 lg:py-2.5 lg:text-sm lg:hover:bg-blue-700 ">
                                {blog ? "Update" : "Upload"}
                            </Button>)
                            :
                            (<Button type="submit" className="w-full text-white bg-blue-600 lg:hover:bg-blue-700  font-medium rounded-md py-3 lg:text-sm px-5 lg:py-2.5 text-center flex items-center justify-center">
