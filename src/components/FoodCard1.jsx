...
function FoodCard1({ food }) {
    ...
    const foodDetails = () => {
        ...
        return (
            <div onClick={foodDetails} className=" w-full h-full bg-white rounded-lg font-poppins flex flex-col justify-between  shadow-md text-[3.7vw] sm:text-[2.1vw] md:text-[1.9vw] lg:p-0  lg:shadow-lg lg:border-0 lg:text-[1.3vw] xl:text-[1.1vw] group  lg:hover:border-[1px] lg:hover:border-black lg:hover:scale-100 lg:scale-95 transition-transform duration-300">
                {/*========== Card Image ==========*/}
                <section className="h-[45%] bg-black rounded-t-lg overflow-hidden">
                    <img src={food?.img} className="w-full h-full object-cover md:group-hover:scale-110 transition-transform duration-300" alt={food?.name} />
                </section>
                ...
                <section className="relative p-2 sm:p-3 h-[55%] gap-1 sm:gap-2 flex flex-col justify-between">
                    ...
                    <div class="relative lg:group duration-500 transform lg:group-hover:-translate-y-3 text-center justify-center items-center">
                        <button onClick={orderBtnHandler} href="/order" class="py-1 px-3  sm:py-2 sm:px-3 md:px-4 lg:px-5 md:font-semibold bg-red-500  rounded-full text-white lg:text-sm">
                            Order Now
                        </button>
                    </div>
                </section>
